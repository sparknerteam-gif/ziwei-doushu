...
__export(index_exports, {
  ALL_STAR_DEFINITIONS: () => ALL_STAR_DEFINITIONS,
  AUXILIARY_STARS: () => AUXILIARY_STARS,
  AUXILIARY_STAR_IDS: () => AUXILIARY_STAR_IDS,
  BRANCH_INDEX: () => BRANCH_INDEX,
  BRANCH_NAMES: () => BRANCH_NAMES,
  BRIGHTNESS_COLORS: () => BRIGHTNESS_COLORS,
  BRIGHTNESS_LABELS: () => BRIGHTNESS_LABELS,
  BRIGHTNESS_TABLE: () => BRIGHTNESS_TABLE,
  COMMON_TERMS: () => COMMON_TERMS,
  DECADE_CYCLE_TERMS: () => DECADE_CYCLE_TERMS,
  FIVE_ELEMENT_NAMES: () => FIVE_ELEMENT_NAMES,
  GENDER_NAMES: () => GENDER_NAMES,
  INDEX_TO_BRANCH: () => INDEX_TO_BRANCH,
  INDEX_TO_STEM: () => INDEX_TO_STEM,
  MAJOR_STARS: () => MAJOR_STARS,
  MAJOR_STAR_IDS: () => MAJOR_STAR_IDS,
  PALACE_BY_ID: () => PALACE_BY_ID,
  PALACE_DEFINITIONS: () => PALACE_DEFINITIONS,
  STAR_BY_ID: () => STAR_BY_ID,
  STEM_INDEX: () => STEM_INDEX,
  STEM_NAMES: () => STEM_NAMES,
  TRANSFORMATION_MAP: () => TRANSFORMATION_MAP,
  TRANSFORMATION_NAMES: () => TRANSFORMATION_NAMES,
  WORLD_CITY_PRESETS: () => WORLD_CITY_PRESETS,
  YIN_YANG_NAMES: () => YIN_YANG_NAMES,
  assignPalaceStems: () => assignPalaceStems,
  assignPalacesToBranches: () => assignPalacesToBranches,
  calculateChart: () => calculateChart,
  calculateChartSync: () => calculateChartSync,
  calculateFourPillars: () => calculateFourPillars,
  calculateMingPalace: () => calculateMingPalace,
  calculateShenPalace: () => calculateShenPalace,
  calculateTrueSolarTime: () => calculateTrueSolarTime,
  formatFourPillars: () => formatFourPillars,
  getBranchForPalace: () => getBranchForPalace,
  getDecadeDirection: () => getDecadeDirection,
  getFiveElementBureau: () => getFiveElementBureau,
  getHourBranch: () => getHourBranch,
  getHourStem: () => getHourStem,
  getMonthBranch: () => getMonthBranch,
  getMonthStem: () => getMonthStem,
  getPalaceAtBranch: () => getPalaceAtBranch,
  getPalaceNameEn: () => getPalaceNameEn,
  getPalaceNameZh: () => getPalaceNameZh,
  getPalaceOrder: () => getPalaceOrder,
  getSexagenaryPosition: () => getSexagenaryPosition,
  getShichen: () => getShichen,
  getStarBrightness: () => getStarBrightness,
  getStarNameEn: () => getStarNameEn,
  getStarNameZh: () => getStarNameZh,
  getTransformations: () => getTransformations,
  getYearBranch: () => getYearBranch,
  getYearStem: () => getYearStem,
...
var import_iztro2 = require("iztro");
...
var import_iztro = require("iztro");
function solarToLunar(year, month, day, hour = 0) {
  const dateStr = `${year}-${month}-${day}`;
  const timeIndex = Math.floor((hour + 1) % 24 / 2);
  const lunarData = import_iztro.calendar.solar2lunar(dateStr);
  const sbData = import_iztro.calendar.getHeavenlyStemAndEarthlyBranchBySolarDate(
    dateStr,
    timeIndex
  );
...
function calculateTrueSolarTime(input) {
  ...
  const localDt = import_luxon.DateTime.fromObject(
...
function calculateChartSync(birthData) {
  ...
  const iztroResult = import_iztro2.astro.astrolabeBySolarDate(
